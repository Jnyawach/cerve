                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Cerve Kenya Admin Dashboard </h2>
                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{route('pending.order')}}"><h5 class="text-muted ">New Orders</h5></a>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1 text-danger">{{$orders->where('is_active', 0)->count()}}</h1>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{route('process.order')}}"><h5 class="text-muted">Processing(Orders)</h5></a>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1 text-success">{{$orders->where('is_active', 1)->count()}}</h1>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{route('active.print')}}" ><h5 class="text-muted">Print on demand</h5></a>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1 text-danger">{{$prints->where('is_active',0)->count()}}</h1>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Request Samples</h5>
                                    <div class="metric-value d-inline-block">
