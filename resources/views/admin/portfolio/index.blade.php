    ...
    <section>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Project Details <a href="{{route('portfolio.create')}}" class="float-right"> <i class="fa fa-pencil-square-o mr-2" aria-hidden="true"></i>Add Project</a> </h5>
                        ...
                        @if($portfolios->count()>0)
                            @foreach($portfolios as $portfolio)
                                <tr>
                                    ...
                                    <td>{{$portfolio->created_at->isoFormat('MMMM Do YYYY')}}</td>

                                    <td>@if($portfolio->is_active==1)
                                    ...
                                    <td>
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a class="dropdown-item" href="{{route('portfolio.show', $portfolio->slug)}}">View <i class="fa fa-bookmark ml-2" aria-hidden="true"></i></a>
                                                {!!Form::open(['method'=>'DELETE','class'=>'dropdown-item', 'action'=>['PortfolioAdminController@destroy', $portfolio->id]])!!}
