...
@import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
    ...
    @media only screen and (max-width:480px) {
      ...
      <div style="background:transparent;background-color:transparent;Margin:0px auto;max-width:780px;">
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/5f7c0eed97b33/1601965833.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="192">
      ...
      <div style="background:#1f1d50;background-color:#1f1d50;Margin:0px auto;max-width:780px;">

        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#1f1d50;background-color:#1f1d50;width:100%;">
          <tbody>
            <tr>
              <td style="direction:ltr;font-size:0px;padding:9px 0px 9px 0px;text-align:center;vertical-align:top;">
                <!--[if mso | IE]>
...
<p><span style="color: #201c4f; font-size: 18px; font-family: tahoma, arial, helvetica, sans-serif;">{{$email}}</span></p>
      ...
      <div style="background:#E8F1F2;background-color:#E8F1F2;Margin:0px auto;max-width:780px;">

        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#E8F1F2;background-color:#E8F1F2;width:100%;">
          <tbody>
            <tr>
              <td style="direction:ltr;font-size:0px;padding:9px 0px 9px 0px;text-align:center;vertical-align:top;">
                <!--[if mso | IE]>
      ...
      <div style="background:#1f1d50;background-color:#1f1d50;Margin:0px auto;max-width:780px;">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#1f1d50;background-color:#1f1d50;width:100%;">
          <tbody>
            <tr>
              <td style="direction:ltr;font-size:0px;padding:37px 0px 37px 0px;text-align:center;vertical-align:top;">
                <!--[if mso | IE]>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
        <p style="text-align: center;"><span style="color: #ffffff; font-family: tahoma, arial, helvetica, sans-serif;">CerveLtd | Contact: +254 717 109280 | Email: support@cervekenya.com | Winglobal Hse. Keekorok Rd.</span></p>
      </div>
