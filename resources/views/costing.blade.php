        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 col-lg-3 mx-auto">
                <a href="{{route('products.show', $product->slug)}}">
                    <img src="{{asset($product->getFirstMedia('product_photos')? $product->getFirstMedia('product_photos')->getUrl('product_card'):'/images/no-image.png' )}}" title="{{$product->name}}" alt="{{$product->name}}" class="img-fluid">
                </a>
            </div>
